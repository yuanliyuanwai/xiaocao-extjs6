...
folder are mapped to the application's root namespace, 'Xiaocao.extjs6'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Xiaocao.extjs6"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Xiaocao.extjs6' in the same way
as `"Xiaocao.extjs6/sass/src"`.
